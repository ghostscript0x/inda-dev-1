  ...
  return (
    <div className="site-shell">
      <header className="site-header">
        <a href="#top" className="wordmark" onClick={closeMenu} aria-label="inda.dev home">
          <span className="wordmark-mark"><img src="/logo.png" alt="" /></span><span>inda<span className="accent-text">.dev</span></span>
        </a>
      ...
      <main id="top">
        <section className="hero section-pad">
          ...
          <div className="hero-visual"><div className="visual-grid" /><div className="visual-corner tl" /><div className="visual-corner br" /><div className="visual-coord tl">41°24·N 2°10·E</div><div className="visual-coord br">v2.6 / 2026</div><div className="visual-mark"><img src="/logo.png" alt="inda.dev logo mark" /></div><div className="visual-id"><span className="visual-name">inda.dev</span><span className="visual-role">Design · Build · Launch</span></div><div className={`profile-slot ${content.profileImage ? 'has-photo' : ''}`} aria-label="Profile photo"><div className="pf-inner"><div className="pf-ring" />{content.profileImage ? <img src={content.profileImage} alt="Profile photo" /> : <div className="pf-mono"><span>AQ</span><small>Profile<br />coming soon</small></div>}<span className="pf-pulse" /></div><span className="pf-corner">inda</span></div><div className="visual-caption">Designing with intent.<br />Building with momentum.</div><div className="visual-stack"><span>REACT</span><span>NEXT.JS</span><span>TAILWIND</span><span>NODE</span></div></div>
        </section>
        ...
        <section className="manifesto section-pad"><p className="eyebrow">A working philosophy</p><blockquote>{manifestoQuote}</blockquote><div className="manifesto-sign">— inda.dev / <span>Independent by design</span></div></section>
      ...
      <footer className="site-footer"><div className="footer-brand"><span className="wordmark-mark"><img src="/logo.png" alt="" /></span><p>inda.dev<br /><span>Innovate. Automate. Elevate.</span></p></div><div className="footer-links"><a href="mailto:hello@inda.name.ng">hello@inda.name.ng</a><a href="https://wa.me/2348055240581">WhatsApp ↗</a><a href="https://www.inda.name.ng">Portfolio ↗</a></div><p className="footer-note">© 2026 inda.dev<br />Built with intent.</p></footer>
    </div>
  )
}
