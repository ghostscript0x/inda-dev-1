...
export function PortfolioShell() {
  ...
  return (
    <div className="site-shell">
      ...
      <footer className="site-footer"><div className="footer-brand"><span className="wordmark-mark"><img src="/logo.png" alt="" /></span><p>inda.dev<br /><span>Innovate. Automate. Elevate.</span></p></div><div className="footer-links"><a href="mailto:hello@inda.name.ng">hello@inda.name.ng</a><a href="https://wa.me/2348055240581">WhatsApp ↗</a><a href="https://inda.name.ng">Portfolio ↗</a></div><p className="footer-note">© 2026 inda.dev<br />Built with intent.</p></footer>
    </div>
  )
}
